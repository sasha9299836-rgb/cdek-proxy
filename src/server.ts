...
import { registerAdminPostVideoRoutes } from "./routes/adminPostVideo";
import { registerAdminDropTeaserRoutes } from "./routes/adminDropTeaser";
...
export async function buildServer() {
  ...
  await registerAdminPostVideoRoutes(app);
  await registerAdminDropTeaserRoutes(app);
